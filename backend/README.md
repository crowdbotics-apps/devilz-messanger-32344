...
## Project Structure
    ...
    ├── devilz_messanger_32344  # Django project configurations
...
1. Clone this repo and `cd devilz_messanger_32344`
...
2. Clone this repo and `cd devilz_messanger_32344`
